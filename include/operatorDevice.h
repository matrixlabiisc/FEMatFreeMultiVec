...
namespace dftfe
{
  ...
  public:
    ...
    virtual void
    HX(dealiiVec<dataTypes::number> &           X,
       distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
       const unsigned int                       localVectorSize,
       const unsigned int                       numberComponents,
       const bool                               scaleFlag,
    ...
    getMFBatchedPartitioner() = 0;

    virtual void
    setupMF(const unsigned int &numberWaveFunctions) = 0;

    virtual void
    HXMF(distributedDeviceVec<dataTypes::number> &X,
         distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
         const unsigned int                       localVectorSize,
         const unsigned int                       numberComponents,
         const bool                               scaleFlag,
    ...
    virtual void
    HXMF(dealiiVec<dataTypes::number> &           X,
         distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
         const unsigned int                       localVectorSize,
         const unsigned int                       numberComponents,
         const bool                               scaleFlag,
    ...
    HXChebyMF(dealiiVec<dataTypes::number> &           X,
              dealiiVec<dataTypes::numberFP32> &       XTemp,
              distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
              const unsigned int                       localVectorSize,
              const unsigned int                       numberComponents,
              dealiiVec<dataTypes::number> &           Y,
