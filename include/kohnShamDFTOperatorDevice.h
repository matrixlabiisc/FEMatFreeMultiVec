...
namespace dftfe
{
  ...
  public:
    ...
    void
    HX(dealiiVec<dataTypes::number> &           src,
       distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
       const unsigned int                       localVectorSize,
       const unsigned int                       numberComponents,
       const bool                               scaleFlag,
    ...
    void
    HXMF(distributedDeviceVec<dataTypes::number> &src,
         distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
         const unsigned int                       localVectorSize,
         const unsigned int                       numberComponents,
         const bool                               scaleFlag,
    ...
    void
    HXMF(dealiiVec<dataTypes::number> &           src,
         distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
         const unsigned int                       localVectorSize,
         const unsigned int                       numberComponents,
         const bool                               scaleFlag,
    ...
    void
    HXCheby(dealiiVec<dataTypes::number> &           X,
            dealiiVec<dataTypes::numberFP32> &       XFloat,
            distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
            const unsigned int                       localVectorSize,
            const unsigned int                       numberComponents,
            dealiiVec<dataTypes::number> &           Y,
            bool                                     mixedPrecflag = false,
            bool                                     computePart1  = false,
            bool                                     computePart2  = false);

    void
    HXChebyMF(distributedDeviceVec<dataTypes::number> &    X,
              distributedDeviceVec<dataTypes::numberFP32> &XFloat,
              distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
              const unsigned int                       localVectorSize,
              const unsigned int                       numberComponents,
    ...
    void
    HXChebyMF(dealiiVec<dataTypes::number> &           X,
              dealiiVec<dataTypes::numberFP32> &       XFloat,
              distributedDeviceVec<dataTypes::number> &projectorKetTimesVector,
              const unsigned int                       localVectorSize,
              const unsigned int                       numberComponents,
  ...
  private:
    ...
    void
    setupMF(const unsigned int &numberWaveFunctions);
    ...
    std::vector<double> d_vEffExternalPotCorrJxW, d_vEffExternalPotCorr,
      d_vEffExternalPotCorrJxWMF;
    dftfe::utils::MemoryStorage<double, dftfe::utils::MemorySpace::DEVICE>
                        d_vEffExternalPotCorrJxWDevice, d_vEffExternalPotCorrJxWMFDevice;
    std::vector<double> d_vEffJxW, d_vEffJxWMF;
    dftfe::utils::MemoryStorage<double, dftfe::utils::MemorySpace::DEVICE>
      d_vEffJxWDevice, d_vEffJxWMFDevice;
    ...
    bool                            isMFSetup;
    std::unique_ptr<matrixFreeBase> d_matrixFreeBasePtr;
