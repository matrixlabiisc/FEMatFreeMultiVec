...
{
  dealii::TimerOutput computing_timerShapefn(getMPICommunicator(),
                                             pcout,
                                             dealii::TimerOutput::summary,
                                             dealii::TimerOutput::wall_times);

  computing_timerShapefn.enter_subsection("shapefn integrals");
  computing_timerShapefn.enter_subsection("init");
